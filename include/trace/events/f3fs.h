...
#undef TRACE_SYSTEM
#define TRACE_SYSTEM f3fs

#if !defined(_TRACE_F3FS_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_F3FS_H
...
#define F3FS_OP_FLAGS (REQ_RAHEAD | REQ_SYNC | REQ_META | REQ_PRIO |	\
			REQ_PREFLUSH | REQ_FUA)
#define F3FS_BIO_FLAG_MASK(t) (__force u32)((t) & F3FS_OP_FLAGS)
...
#define show_bio_op_flags(flags)					\
	__print_flags(F3FS_BIO_FLAG_MASK(flags), "|",			\
...
#define show_shutdown_mode(type)					\
	__print_symbolic(type,						\
		{ F3FS_GOING_DOWN_FULLSYNC,	"full sync" },		\
		{ F3FS_GOING_DOWN_METASYNC,	"meta sync" },		\
		{ F3FS_GOING_DOWN_NOSYNC,	"no sync" },		\
		{ F3FS_GOING_DOWN_METAFLUSH,	"meta flush" },		\
		{ F3FS_GOING_DOWN_NEED_FSCK,	"need fsck" })
...
DECLARE_EVENT_CLASS(f3fs__inode,
	...
	TP_fast_assign(
		...
		__entry->pino	= F3FS_I(inode)->i_pino;
		__entry->mode	= inode->i_mode;
		__entry->nlink	= inode->i_nlink;
		__entry->size	= inode->i_size;
		__entry->blocks	= inode->i_blocks;
		__entry->advise	= F3FS_I(inode)->i_advise;
	),
...
DECLARE_EVENT_CLASS(f3fs__inode_exit,
...
DEFINE_EVENT(f3fs__inode, f3fs_sync_file_enter,
...
TRACE_EVENT(f3fs_sync_file_exit,
...
TRACE_EVENT(f3fs_sync_fs,
	...
	TP_fast_assign(
		...
		__entry->dirty	= is_sbi_flag_set(F3FS_SB(sb), SBI_IS_DIRTY);
		__entry->wait	= wait;
	),
...
DEFINE_EVENT(f3fs__inode, f3fs_iget,
...
DEFINE_EVENT(f3fs__inode_exit, f3fs_iget_exit,
...
DEFINE_EVENT(f3fs__inode, f3fs_evict_inode,
...
DEFINE_EVENT(f3fs__inode_exit, f3fs_new_inode,
...
DEFINE_EVENT(f3fs__inode_exit, f3fs_unlink_exit,
...
DEFINE_EVENT(f3fs__inode_exit, f3fs_drop_inode,
...
DEFINE_EVENT(f3fs__inode, f3fs_truncate,
...
TRACE_EVENT(f3fs_truncate_data_blocks_range,
...
DECLARE_EVENT_CLASS(f3fs__truncate_op,
...
DEFINE_EVENT(f3fs__truncate_op, f3fs_truncate_blocks_enter,
...
DEFINE_EVENT(f3fs__inode_exit, f3fs_truncate_blocks_exit,
...
DEFINE_EVENT(f3fs__truncate_op, f3fs_truncate_inode_blocks_enter,
...
DEFINE_EVENT(f3fs__inode_exit, f3fs_truncate_inode_blocks_exit,
...
DECLARE_EVENT_CLASS(f3fs__truncate_node,
...
DEFINE_EVENT(f3fs__truncate_node, f3fs_truncate_nodes_enter,
...
DEFINE_EVENT(f3fs__inode_exit, f3fs_truncate_nodes_exit,
...
DEFINE_EVENT(f3fs__truncate_node, f3fs_truncate_node,
...
TRACE_EVENT(f3fs_truncate_partial_nodes,
...
TRACE_EVENT(f3fs_file_write_iter,
...
TRACE_EVENT(f3fs_map_blocks,
	TP_PROTO(struct inode *inode, struct f3fs_map_blocks *map,
...
TRACE_EVENT(f3fs_background_gc,
...
TRACE_EVENT(f3fs_direct_IO_enter,
...
TRACE_EVENT(f3fs_direct_IO_exit,
...
TRACE_EVENT(f3fs_reserve_new_blocks,
...
DECLARE_EVENT_CLASS(f3fs__submit_page_bio,

	TP_PROTO(struct page *page, struct f3fs_io_info *fio),
...
DEFINE_EVENT_CONDITION(f3fs__submit_page_bio, f3fs_submit_page_bio,
...
DEFINE_EVENT_CONDITION(f3fs__submit_page_bio, f3fs_submit_page_write,
...
DEFINE_EVENT_CONDITION(f3fs__bio, f3fs_prepare_write_bio,
...
DEFINE_EVENT_CONDITION(f3fs__bio, f3fs_prepare_read_bio,
...
DEFINE_EVENT_CONDITION(f3fs__bio, f3fs_submit_read_bio,
...
DEFINE_EVENT_CONDITION(f3fs__bio, f3fs_submit_write_bio,
...
DECLARE_EVENT_CLASS(f3fs__page,
...
DEFINE_EVENT(f3fs__page, f3fs_writepage,
...
DEFINE_EVENT(f3fs__page, f3fs_do_write_data_page,
...
DEFINE_EVENT(f3fs__page, f3fs_readpage,
...
DEFINE_EVENT(f3fs__page, f3fs_set_page_dirty,
...
DEFINE_EVENT(f3fs__page, f3fs_vm_page_mkwrite,
...
TRACE_EVENT(f3fs_filemap_fault,
...
TRACE_EVENT(f3fs_write_checkpoint,
...
DECLARE_EVENT_CLASS(f3fs_discard,
...
DEFINE_EVENT(f3fs_discard, f3fs_queue_discard,
...
DEFINE_EVENT(f3fs_discard, f3fs_issue_discard,
...
DEFINE_EVENT(f3fs_discard, f3fs_remove_discard,
...
TRACE_EVENT(f3fs_issue_reset_zone,
...
TRACE_EVENT(f3fs_lookup_extent_tree_start,
...
TRACE_EVENT_CONDITION(f3fs_lookup_extent_tree_end,
...
TRACE_EVENT(f3fs_update_extent_tree_range,
...
TRACE_EVENT(f3fs_shrink_extent_tree,

	TP_PROTO(struct f3fs_sb_info *sbi, unsigned int node_cnt,
...
TRACE_EVENT(f3fs_destroy_extent_tree,
...
DECLARE_EVENT_CLASS(f3fs_sync_dirty_inodes,
...
DEFINE_EVENT(f3fs_sync_dirty_inodes, f3fs_sync_dirty_inodes_enter,
...
DEFINE_EVENT(f3fs_sync_dirty_inodes, f3fs_sync_dirty_inodes_exit,
...
TRACE_EVENT(f3fs_shutdown,

	TP_PROTO(struct f3fs_sb_info *sbi, unsigned int mode, int ret),
...
DECLARE_EVENT_CLASS(f3fs_zip_start,
...
DECLARE_EVENT_CLASS(f3fs_zip_end,
...
DEFINE_EVENT(f3fs_zip_start, f3fs_compress_pages_start,
...
DEFINE_EVENT(f3fs_zip_start, f3fs_decompress_pages_start,
...
DEFINE_EVENT(f3fs_zip_end, f3fs_compress_pages_end,
...
DEFINE_EVENT(f3fs_zip_end, f3fs_decompress_pages_end,
...
TRACE_EVENT(f3fs_iostat,

	TP_PROTO(struct f3fs_sb_info *sbi, unsigned long long *iostat),
...
#ifndef __F3FS_IOSTAT_LATENCY_TYPE
#define __F3FS_IOSTAT_LATENCY_TYPE
struct f3fs_iostat_latency {
	unsigned int peak_lat;
	unsigned int avg_lat;
	unsigned int cnt;
};
#endif /* __F3FS_IOSTAT_LATENCY_TYPE */

TRACE_EVENT(f3fs_iostat_latency,

	TP_PROTO(struct f3fs_sb_info *sbi, struct f3fs_iostat_latency (*iostat_lat)[NR_PAGE_TYPE]),
...
DECLARE_EVENT_CLASS(f3fs__rw_start,
...
DECLARE_EVENT_CLASS(f3fs__rw_end,
...
DEFINE_EVENT(f3fs__rw_start, f3fs_dataread_start,
...
DEFINE_EVENT(f3fs__rw_end, f3fs_dataread_end,
...
DEFINE_EVENT(f3fs__rw_start, f3fs_datawrite_start,
...
DEFINE_EVENT(f3fs__rw_end, f3fs_datawrite_end,
